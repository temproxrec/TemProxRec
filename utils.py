...
def create_experiment_export_folder(args):
    ...
    file_name = f'{args.dataset_code}/hid:{args.bert_hidden_units}-{args.ctl}-interval:{args.interval}-temp:{args.temperature}-k:{args.time_unit_divide}-wd:{args.weight_decay}-w:{args.w1}&{args.w2}'
